"""Python backend: local registration + spot finding on a single subtile.

Pipeline: load subtile NPZ -> local register -> spot find -> extract -> filter.
"""
...
params = snakemake.config["rules"]["lrsf_single_fov_subtile"]["parameters"]
...
# --- Save outputs ---
# Save subtile-specific goodSpots CSV
...
# Save score log with subtile suffix
