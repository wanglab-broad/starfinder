...
function sdata = deep_create_subtile(config_path, current_fov)
    ...
    % save subtile 
    if config.rules.deep_create_subtile.parameters.create_subtiles.run
        sdata = sdata.CreateSubtiles('sqrt_pieces', config.rules.deep_create_subtile.parameters.create_subtiles.sqrt_pieces, 'save', true);
    end
