...
"path={snakemake.config['root_output_path']}/{snakemake.config['dataset_id']}/{snakemake.config['output_id']}/images/fused/{snakemake.wildcards.sample}/DAPI exclude=10 pattern_0=Tiles " +
...
"keep_metadata_rotation how_to_load_images=[Re-save as multiresolution N5] load_raw_data_virtually " +
"dataset_save_path={snakemake.config['root_output_path']}/{snakemake.config['dataset_id']}/{snakemake.config['output_id']}/images/fused/{snakemake.wildcards['sample']}/DAPI compression=Gzip " +
"subsampling_factors=[{{1,1,1}}, {{4,4,4}}] n5_block_sizes=[{{128,128,64}}, {{128,128,64}}] number_of_threads=8");
