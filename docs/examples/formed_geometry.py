"""Bounded synthetic/1 A7 shared-map example, with independent expected values."""
...
def run():
    ...
    for depth in (3, 1):
        ...
        extension = scene.provenance['extensions']['starfinder.synthetic']
        assert all(t['inverse']['max_residual'] <= 2e-10 for t in extension['transforms'].values())
