"""Versioned, bounded comparisons built on the formed-scene contract."""
from dataclasses import replace

from ._formed import (BackgroundConfig, NoiseConfig, ReadoutEffectsConfig,
                      ScalarDistribution, TextureConfig, formed_scene_preset)
from ._geometry import GeometryConfig

DEVELOPMENT_SIZES = {"z1": (1, 32, 32), "small": (9, 32, 32), "wide": (9, 48, 48)}
DEVELOPMENT_FACTORS = (
...
def development_scene_preset(condition="clean", *, size="small"):
    ...
    is z1, small or wide. Each size shares one reference scene across conditions,
    ...
    Appearance and placement changes are separate comparisons against clean.
    All outputs are development-only, uncalibrated processed-image fixtures.
    """
