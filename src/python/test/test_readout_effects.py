"""Independent readout expectations and component invariance under synthetic/1."""
...
def test_disabled_controls_and_identity_mixing():
    ...
    payload = scenes[0].provenance['extensions']['starfinder.synthetic']
    ...
    assert payload['streams'] == baseline.provenance['extensions']['starfinder.synthetic']['streams']
...
def test_independent_random_laws_isolation_and_scheduling():
    ...
    assert scene.provenance['extensions']['starfinder.synthetic']['streams'] == changed.provenance['extensions']['starfinder.synthetic']['streams']
