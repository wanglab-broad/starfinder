...
% test block
input_path = fullfile('/stanley/WangLab/Data/Processed/2023-10-01-Jiahao-Test/mAD_64/');
output_path = fullfile('/stanley/WangLab/Data/Analyzed/2023-10-01-Jiahao-Test/mAD_64/');
ref_round = ["round1"];
...
diary_file = fullfile(output_path, sprintf("%s.txt", current_fov));
