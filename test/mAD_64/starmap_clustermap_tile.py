...
# %%
### set file folder
ppath = '/stanley/WangLab/Data/Processed/2021-11-23-Hu-MouseBrainSTARmap/output/max_cluster/'
dpath = '/stanley/WangLab/Data/Processed/2021-11-23-Hu-MouseBrainSTARmap/round1/'
opath = '/stanley/WangLab/Data/Processed/2021-11-23-Hu-MouseBrainSTARmap/output/clustermap/'
...
model = ClusterMap(spots=spots, dapi=dapi, gene_list=gene_list, num_dims=num_dims, gauss_blur=True, sigma=3,
