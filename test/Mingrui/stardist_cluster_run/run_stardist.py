...
base_path = '/stanley/WangLab/Data/Analyzed/2024-03-12-Mingrui-PFC/images/'
data_path = os.path.join(base_path, 'DAPI')
output_path = os.path.join(base_path, 'stardist_segmentation')
if not os.path.exists(output_path):
    os.mkdir(output_path)

model_path = '/stanley/WangLab/Tools/stardist_models/'
model = StarDist3D(None, name='3D_brain', basedir=model_path)
...
labels, details = model.predict_instances(current_img, n_tiles=[1, 8, 8], prob_thresh=prob_thresh, nms_thresh=nms_thresh)
