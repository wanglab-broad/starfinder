...
# Load images
current_gray_img = imread(os.path.join(image_path, 'DAPI', f"{current_fov_id}.tif"))
current_gray_max = np.max((current_gray_img), axis=0)
current_label_img = imread(os.path.join(image_path, 'cell_segmentation', f"{current_fov_id}.tif"))
